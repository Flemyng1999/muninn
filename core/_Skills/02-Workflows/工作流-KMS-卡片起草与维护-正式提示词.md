...
### E. 单卡内容维护（R08 §8.7 编辑深度矩阵 + §8.8 内容卫生）

先做内容卫生检查：长期卡片正文只写事实、设置、证据、机制、边界、验证。临时路线名、明天动作、任务优先级、agent 分工、"Claude/Codex 认为"这类过程语应留在 Journal / WORKING / GAPS / 任务区，或改写为客观证据句。
