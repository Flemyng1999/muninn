...
> [!abstract]- 适用场景
> 把这套 KMS（宪法 v0.1.4 + 骨架 + AI 工作流）交给另一个人（同事 / 学生 / 合作者）使用。他得到一份**脱敏模板仓库**，按两周节奏表独立上手。
>
...
你交接给的人两周后再想传给第三人 → 他重跑 `make_kms_template.sh` 在他自己的 vault 上，产出他的脱敏版。宪法 v0.1.4 保持不变（这是 L0 层）。
