...
### KMS-DEBT-001 — 模板内置 workflows 引用未自建的辅助卡片
...
**当前选择**：未定。建议 v0.1.4 选 **方案 A**（最小改动 + 教学价值最高，因为
显式登记 wish-cards 让用户从 Day 1 就知道"这些是要建的"）。
...
还在 hsi-canopy-relight 项目侧 538 行版本里，未反哺。
